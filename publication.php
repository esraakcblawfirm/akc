...
<head>
    ...
    <!-- Document title -->
    <title>AKCBLAWFIRM - Yayınlarımız</title>
    <!-- Stylesheets & Fonts -->
                        ...
                        <li>
                            <div class="topbar-dropdown">
                                ...
                                <div class="dropdown-list">
                                    <a class="list-entry" href="language/language.php?lang=tr&page=publication">Türkçe</a>
                                    <a class="list-entry" href="language/language.php?lang=en&page=publication">English</a>
                                </div>
                            </div>
                        </li>
                    </ul>
